/* código de teste... 
alocando memória pra estrutura, zerando, apontando membros para a primeira posição na memória ( apontando para NULL pq não estou usando aquela variável naquela linha )
